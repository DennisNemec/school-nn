...
class IntegrationTestCase(StaticLiveServerTestCase):
    ...
    def setUp(self) -> None:
        ...
        self.user = User.objects.create(username='peter', password=make_password(self.password))

    @staticmethod
    def get_browser() -> Coroutine[Any, Any, Browser]:
        return launch(handleSIGINT=False, handleSIGTERM=False, handleSIGHUP=False, headless=False)
